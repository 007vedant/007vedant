...
- 🖥️  Presently, senior software engineer [**@Harness**](https://www.harness.io), ex-SDE2 [**@Amazon**](https://github.com/amzn), Ex-intern [**@CNCF**](https://github.com/cncf) with [**@Kubernetes**](https://github.com/kubernetes/kubernetes) org, **@SamsungResearch**
